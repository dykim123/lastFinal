...
table {
	width: 800px;
	text-align: center;
	border-top: 1px solid #444444; /*테이블 테두리 양옆없게*/
	/*border: 1px solid grey;*/
	width: 400px;
	height: 400px;
	margin-left: auto; /*테이블 가운데 정렬*/
	margin-right: auto;  /*테이블 가운데 정렬*/
}

th,tr ,td {
	/* border: 1px solid grey;*/
	border-bottom: 1px solid #444444; /*테이블 테두리 양옆없게*/
	padding: 10px;
	text-align: center;
}
</style>
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div id="navbar-container" class="boxed">
			...
			<div class="navbar-header">
				<a href="#" class="navbar-brand"> 
					<img src="../img/CampingXML_LOGO.png" class="brand-icon"
					style="width: 30px; height: 30px; margin-top: 8px; margin-left: 12px;">
		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<div id="page-title">
					<h1 class="page-header text-overflow">내 급여 조회</h1>
				...
				<div id="page-content">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">내 급여 조회</h3>
						</div>
		...
		<!-- FOOTER -->
		<!--===================================================-->
		<footer id="footer"> <!-- Visible when footer positions are fixed -->
		<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
