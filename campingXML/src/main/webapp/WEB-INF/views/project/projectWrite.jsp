				...
				<div id="page-content">
					...
					<div class="panel">
						...
						<div class="panel-heading">
							<h3 class="panel-title"><strong>프로젝트 등록</strong></h3>
						</div>	
							...
							<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9" id="sandbox-container">
											...
											<small class="help-block">시작일은 작성일 다음날부터 설정할 수 있습니다.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control" placeholder="김도연 과장 (부서)" disabled>
											<small class="help-block">담당자는 작성자로 자동설정되며 후에 변경할 수 있습니다.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<!-- ??왜 첫글자만 검색될까 -->
											<!-- !!option => 직원명 직급 [사번] -->
											<select data-placeholder="  " multiple class="chosen-select">
												<option value="">ab</option>
												<option value="">abc</option>
												<option value="">cba</option>
											</select>
											<small class="help-block">여러 명의 직원을 선택할 수 있습니다.</small>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea rows="15" class="form-control" style="resize: none"></textarea>
										</div>
									</div>
								...
								<div class="panel-footer text-center"> 
									<button class="btn btn-info" style="width: 100px" type="submit">등록</button>  
								</div>
