...
<body>
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<div id="page-title">
					<h1 class="page-header text-overflow">사원 등록</h1>
							...
							<form class="form-horizontal" method="post"
								...
								<div class="panel-body">
									<div class="form-group">
										...
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">사원번호</label>
										<div class="col-sm-6">
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">사원명</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">부서명</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">직급</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">급여(직급별 급여)</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">재직상태</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">입사일</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">퇴사일</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">전화번호</label>
										<div class="col-sm-6">
											<input type="text" placeholder="010-0101-0100"
												class="form-control" id="demo-is-inputnormal">
										</div>
									</div>
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">우편번호</label>
										<div class="col-sm-3">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">기본 주소</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">상세 주소</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">은행</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">계좌번호</label>
										<div class="col-sm-6">
											<input type="text" placeholder="" class="form-control"
												id="demo-is-inputnormal">
										</div>
									...
									<div class="form-group">
										<label for="demo-is-inputnormal"
											class="col-sm-3 control-label">비밀번호</label>
										<div class="col-sm-6">
											<input type="text" placeholder="초기 비번 = 사원번호"
												class="form-control" id="demo-is-inputnormal">
										</div>
									</div>
								</div>
								<div class="text-center">
									<button class="btn btn-info" type="submit">
										<a href="insaFirstpage.html">등록</a>
									</button>
								</div>
							</form>
								...
								<ul id="mainnav-menu" class="list-group">
									...
									<li><a href="index.html"> <i class="fa fa-dashboard"></i>
											<span class="menu-title"> <strong>Dashboard</strong> <span
												class="label label-success pull-right">Top</span>
										</span>
									</a></li>
									...
									<li><a href="#"> <i class="fa fa-briefcase"></i> <span
											class="menu-title">UI Elements</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
											<li><a href="ui-buttons.html">Buttons</a></li>
											<li><a href="ui-checkboxes-radio.html">Checkboxes
													&amp; Radio</a></li>
											...
											<li><a href="ui-tabs-accordions.html">Tabs &amp;
													Accordions</a></li>
											<li><a href="ui-alerts-tooltips.html">Alerts &amp;
													Tooltips</a></li>
									...
									<li><a href="#"> <i class="fa fa-edit"></i> <span
											class="menu-title">Forms</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
									...
									<li><a href="#"> <i class="fa fa-table"></i> <span
											class="menu-title">Tables</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
									...
									<li><a href="#"> <i class="fa fa-envelope"></i> <span
										...
										<ul class="collapse">
											<li><a href="mailbox.html">사원 조회</a></li>
											<li><a href="mailbox.html">사원 등록</a></li>
											<!-- 
 ...
 -->
									...
									<!--Menu list item-->
									<li class="active-sub"><a href="#">
									 <i class="fa fa-file"></i> <span class="menu-title">급여 관리</span>
											<i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse in">
											<li class="active-link"><a href="pages-blank.html">
											급여 조회</a></li>
											<li class="active-link"><a href="pages-blank.html">
											급여 등록</a></li>
