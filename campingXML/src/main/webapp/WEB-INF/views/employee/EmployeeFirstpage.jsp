						...
						<li id="dropdown-user" class="dropdown"><a href="#"
							data-toggle="dropdown" class="dropdown-toggle text-right"> <span
								class="pull-right"> <img
									class="img-circle img-user media-object" src="img/av1.png"
									alt="Profile Picture">
							</span>
							...
							<div
								class="dropdown-menu dropdown-menu-md dropdown-menu-right with-arrow panel-default">

								<!-- Dropdown heading  -->
								<!--
								<div class="pad-all bord-btm">
									 <p class="text-lg text-muted text-thin mar-btm">750Gb of
										1,000Gb Used</p>
...
-->
		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
				<div id="page-title">
					<h1 class="page-header text-overflow">사원 조회</h1>
							...
							<form class="form-horizontal">
								<div class="panel-body">
									<div class="form-group">
										<label class="col-sm-3 control-label"
											for="demo-hor-inputemail">사원명</label>
										<div class="col-sm-9">
											<input type="email" placeholder="" id="demo-hor-inputemail"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="demo-hor-inputpass">사원번호</label>
										<div class="col-sm-9">
											<input type="password" placeholder="" id="demo-hor-inputpass"
												class="form-control">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label" for="demo-hor-inputpass">이메일</label>
										<div class="col-sm-9">
											<input type="password" placeholder="" id="demo-hor-inputpass"
												class="form-control">
										</div>
								...
								<div class="text-center">
									...
									<button class="btn btn-info">
										<a href="addNewEmployee.html">사원 추가</a>
									</button>
								</div>
							</form>
							...
							<table id="demo-dt-basic"
								...
								<thead>
									<tr>
										<th>사원번호</th>
										<th>성명</th>
										<th class="min-tablet">부서명</th>
										<th class="min-tablet">직급</th>
										<th class="min-desktop">입사일자</th>
								...
								<tbody>
									<tr>
										<td>2019100</td>
										<td data-target="#demo-default-modal" data-toggle="modal">차소정</td>
										<td>인사부</td>
										<td>대리</td>
										<td>2019/04/25</td>
										<td>aaa@gmail.com</td>
									...
									<tr>
										<td>2018055</td>
										<td data-target="#demo-default-modal" data-toggle="modal">가나다</td>
										<td>인사부</td>
										<td>부장</td>
										<td>2018/01/12</td>
										<td>bbb@gmail.com</td>
						...
						<div class="nano has-scrollbar">
						 ...
						 -->
									...
									<li><a href="#"> <i class="fa fa-th"></i> <span
											class="menu-title"> <strong>Layouts</strong>
										</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
											<li><a href="layouts-collapsed-navigation.html">Collapsed
													Navigation</a></li>
											<li><a href="layouts-offcanvas-navigation.html">Off-Canvas
													Navigation</a></li>
											<li><a href="layouts-offcanvas-slide-in-navigation.html">Slide-in
													Navigation</a></li>
											<li><a
												href="layouts-offcanvas-revealing-navigation.html">Revealing
													Navigation</a></li>
											<li class="list-divider"></li>
											<li><a href="layouts-aside-right-side.html">Aside on
													the right side</a></li>
											<li><a href="layouts-aside-left-side.html">Aside on
													the left side</a></li>
											<li><a href="layouts-aside-bright-theme.html">Bright
													aside theme</a></li>
											<li class="list-divider"></li>
									...
									<!--Menu list item-->
									<li><a href="widgets.html"> <i class="fa fa-flask"></i>
											<span class="menu-title"> <strong>Widgets</strong> <span
												class="pull-right badge badge-warning">9</span>
										</span>
									...
									<li><a href="#"> <i class="fa fa-briefcase"></i> <span
											class="menu-title">인사관리</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
											<li><a href="insaFirstpage.jsp">사원 조회</a></li>
											<li><a href="addNewEmployee.jsp">사원 등록</a></li>
										</ul></li>

									<!--Menu list item-->
									<li><a href="#"> <i class="fa fa-edit"></i> <span
											class="menu-title">급여관리</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
											<li><a href="payFirstPage.jsp">급여 조회</a></li>
											<li><a href="addNewPay.jsp">급여 등록</a></li>
											<!-- 
									...
									<!--Menu list item-->
									<li class="active-sub active"><a href="#"> <i
											class="fa fa-table"></i> <span class="menu-title">Tables</span>
											<i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse in">
											<li><a href="tables-static.html">Static Tables</a></li>
											<li><a href="tables-bootstrap.html">Bootstrap Tables</a></li>
											<li class="active-link"><a href="tables-datatable.html">Data
													Tables<span class="label label-info pull-right">New</span>
											</a></li>
									...
									<!--Menu list item-->
									<li><a href="#"> <i class="fa fa-plug"></i> <span
											class="menu-title"> Miscellaneous <span
												class="label label-mint pull-right">New</span>
										</span>
									</a> <!--Submenu-->
										<ul class="collapse">
									...
									<li><a href="#"> <i class="fa fa-envelope"></i> <span
											class="menu-title">Email</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
									...
									<li><a href="#"> <i class="fa fa-file"></i> <span
											class="menu-title">Pages</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
											...
											<li><a href="pages-password-reminder.html">Password
													Reminder</a></li>
									...
									<li><a href="#"> <i class="fa fa-plus-square"></i> <span
											class="menu-title">Menu Level</span> <i class="arrow"></i>
									</a> <!--Submenu-->
										<ul class="collapse">
								...
								<div class="mainnav-widget">
									...
									<div class="show-small">
										<a href="#" data-toggle="menu-widget"
											data-target="#demo-wg-server"> <i class="fa fa-desktop"></i>
										</a>
									</div>

									<!-- Hide the content on collapsed navigation -->
									<div id="demo-wg-server"
										class="hide-small mainnav-widget-content">
										<ul class="list-group">
											<li class="list-header pad-no pad-ver">Server Status</li>
											<li class="mar-btm"><span
												class="label label-primary pull-right">15%</span>
												<p>CPU Usage</p>
												<div class="progress progress-sm">
											...
											<li class="mar-btm"><span
												class="label label-purple pull-right">75%</span>
												<p>Bandwidth</p>
												<div class="progress progress-sm">
				...
				<div class="modal-body">
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tr>
								<td class="text-center">3*4t사진</td>
							...
							<tr>
								<td class="text-center">입사일</td>
								<td><a href="#" class="btn-link">Teresa L. Doe</a></td>
							</tr>
							<tr>
								<td class="text-center">퇴사일</td>
								<td><a href="#" class="btn-link">Teresa L. Doe</a></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="text-center">급여</td>
								<td><a href="#" class="btn-link">Teresa L. Doe</a></td>
							</tr>
							<tr>
								<td class="text-center">은행</td>
								<td><a href="#" class="btn-link">Teresa L. Doe</a></td>
							</tr>
							<tr>
							...
							<tr>
								<td class="text-center">로그인 비밀번호</td>
								<td><a href="#" class="btn-link">초기) 사번</a></td>
							</tr>
