				...
				<div id="page-content">
					<div class="panel">
						...
						<div class="panel-heading">
							...
							<h3 class="panel-title"><strong>프로젝트명[프로젝트코드]의 업무일지 수정</strong></h3>
						</div>
						...
						<form class="form-horizontal form-padding">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="기존의 업무일지 제목">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<textarea rows="27" class="form-control" style="resize: none" placeholder="기존의 업무일지 내용"></textarea>
									</div>
								</div>
								
							</div>
							<div class="panel-footer text-center"> 
								<button class="btn btn-mint" style="width: 100px">초기화</button>  
